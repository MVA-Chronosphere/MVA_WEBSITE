...
const AdmissionsPage: React.FC = () => {
  ...
  // Button handlers
  const handleAdmissionInquiry = () => {
    // You can add a modal or navigate to an inquiry page
    // For now, let's show an alert or you can implement a modal
  navigate('/studentAdmissionForm');
  };

  const handleRegisterForEntrance = () => {
    // Open the external registration form in new tab
    window.open("https://schoolknot.com/web-forms/macro_vision_academy_enquiry_form.php", "_blank");
  };
  ...
  <button 
    className="bg-white text-blue-900 px-6 py-3 rounded-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center gap-2 hover:scale-105 text-sm"
    onClick={handleRegisterForEntrance}
  >
  ...
  <button 
    className="bg-blue-600 border-2 border-blue-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-blue-700 transition-all duration-300 hover:scale-105 text-sm"
    onClick={handleAdmissionInquiry}
  >
    Admission Inquiry
  </button>
  <button 
    className="bg-transparent border-2 border-white text-white px-6 py-3 rounded-lg font-semibold hover:bg-white/10 transition-all duration-300 hover:scale-105 text-sm"
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-blue-900 to-indigo-800 text-white relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button
              className="bg-transparent border-2 border-white text-white px-10 py-4 rounded-lg font-bold text-lg hover:bg-white/10 transition-all duration-300 hover:scale-105"
              onClick={handleAdmissionInquiry}
            >
              Admission Inquiry
            </button>
