import { MapPin, Phone, Mail, Clock, Loader2, Contact, FileText, Upload } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12">
          ...
          <div>
            ...
            {/* KEY: form must have encType for file uploads */}
            <form 
              className="space-y-4" 
              onSubmit={handleSubmit}
              encType="multipart/form-data" // This is crucial for file uploads
            >
              <Input 
                name="name"
                type="text" 
              ...
              {/* {selectedTopic === "Career Enquiry" && (
                <div className="space-y-2">
                  ...
                  <div className="border-2 border-dashed border-gray-300 rounded-lg p-4 text-center hover:border-primary transition-colors">
                    <input
                      id="resume"
                      name="resume" // KEY: Must have name attribute
                      type="file"
          ...
          <div>
            ...
            {/* <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-6">
              ...
              <p className="text-blue-800 text-sm mb-4">
                Upload your resume with career enquiries. We support PDF, DOC, DOCX files up to 5MB.
              </p>
            </div> */}
          </div>
        </div>
